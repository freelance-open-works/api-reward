...
--
-- Host: localhost    Database: reward
-- ------------------------------------------------------
...
CREATE TABLE `admins` (
  ...
  `is_super` bigint(20) NOT NULL DEFAULT 1,
  PRIMARY KEY (`id`)
...
(1,'admin','$2y$10$eOQ7mu749fkRJqQtBh1Sp.1nJDB2jBR5TJizDIlGYoga/BL/QKbNu','2021-07-31 16:27:47','2023-01-17 18:31:51',1,1),
(6,'neo','$2y$10$efpam3LFLvg88PqmPcs0dO7Iw0xVoqiPRKuXQK37wbS5ndIrC4mFW','2023-01-17 18:45:47','2023-01-17 18:45:47',2,0);
...
CREATE TABLE `catalogue` (
  ...
  KEY `fk_cat_per` (`ID_PERIOD`),
  KEY `fk_cat_cattype` (`ID_CTG_TYPE`),
  CONSTRAINT `fk_cat_cattype` FOREIGN KEY (`ID_CTG_TYPE`) REFERENCES `catalogue_type` (`ID_CTG_TYPE`),
  CONSTRAINT `fk_cat_per` FOREIGN KEY (`ID_PERIOD`) REFERENCES `year_period` (`ID_PERIOD`) ON DELETE CASCADE
...
LOCK TABLES `catalogue_type` WRITE;
/*!40000 ALTER TABLE `catalogue_type` DISABLE KEYS */;
INSERT INTO `catalogue_type` VALUES
(1,'Grand Prize','1'),
(2,'Normal','unlimited');
/*!40000 ALTER TABLE `catalogue_type` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `device_version` (
  `ID_DEVICE_VERSION` int(11) NOT NULL AUTO_INCREMENT,
  `DEVICE` varchar(100) DEFAULT NULL,
  `VERSION` varchar(10) DEFAULT NULL,
  PRIMARY KEY (`ID_DEVICE_VERSION`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `device_version` VALUES
(1,'android','3'),
(2,'ios','3');
...
--
-- Table structure for table `elearning_challenge`
--

DROP TABLE IF EXISTS `elearning_challenge`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `elearning_challenge` (
  `ID_ELEARNING_CHALLENGE` int(11) NOT NULL AUTO_INCREMENT,
  ...
  `ID_PERIOD` int(11) NOT NULL,
  PRIMARY KEY (`ID_ELEARNING_CHALLENGE`),
  KEY `fk_elearn_yperiod` (`ID_PERIOD`),
  CONSTRAINT `fk_elearn_yperiod` FOREIGN KEY (`ID_PERIOD`) REFERENCES `year_period` (`ID_PERIOD`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `elearning_challenge`
--

LOCK TABLES `elearning_challenge` WRITE;
/*!40000 ALTER TABLE `elearning_challenge` DISABLE KEYS */;
/*!40000 ALTER TABLE `elearning_challenge` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `elearning_challenge_backup`
--

DROP TABLE IF EXISTS `elearning_challenge_backup`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
--
-- Dumping data for table `elearning_challenge_backup`
--

LOCK TABLES `elearning_challenge_backup` WRITE;
/*!40000 ALTER TABLE `elearning_challenge_backup` DISABLE KEYS */;
/*!40000 ALTER TABLE `elearning_challenge_backup` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `elearning_history`
--

DROP TABLE IF EXISTS `elearning_history`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `elearning_history` (
  `ID_ELEARNING_HISTORY` int(11) NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`ID_ELEARNING_HISTORY`),
  KEY `fk_elhis_users` (`ID_USERS`),
  KEY `fk_elhis_elchall` (`ID_ELEARNING_CHALLENGE`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `elearning_history`
--

LOCK TABLES `elearning_history` WRITE;
/*!40000 ALTER TABLE `elearning_history` DISABLE KEYS */;
/*!40000 ALTER TABLE `elearning_history` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `elearning_history_backup`
--

DROP TABLE IF EXISTS `elearning_history_backup`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
--
-- Dumping data for table `elearning_history_backup`
--

LOCK TABLES `elearning_history_backup` WRITE;
/*!40000 ALTER TABLE `elearning_history_backup` DISABLE KEYS */;
/*!40000 ALTER TABLE `elearning_history_backup` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `elearning_history_original`
--

DROP TABLE IF EXISTS `elearning_history_original`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `elearning_history_original` (
  ...
  KEY `fk_elhis_users` (`ID_USERS`),
  KEY `fk_elhis_elchall` (`ID_ELEARNING_CHALLENGE`),
  CONSTRAINT `fk_elhis_elchall` FOREIGN KEY (`ID_ELEARNING_CHALLENGE`) REFERENCES `elearning_challenge` (`ID_ELEARNING_CHALLENGE`),
  CONSTRAINT `fk_elhis_users` FOREIGN KEY (`ID_USERS`) REFERENCES `users` (`ID_USERS`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `elearning_history_original`
--

LOCK TABLES `elearning_history_original` WRITE;
/*!40000 ALTER TABLE `elearning_history_original` DISABLE KEYS */;
/*!40000 ALTER TABLE `elearning_history_original` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `event_detail` (
  ...
  KEY `FK_RELATIONSHIP_4` (`ID_EVENTS`),
  KEY `fk_evdet_evrole` (`ID_EVENT_ROLE`)
...
CREATE TABLE `events` (
  ...
  KEY `fk_event_per` (`ID_PERIOD`),
  KEY `fk_event_evtype` (`ID_EVENT_TYPE`),
  CONSTRAINT `fk_event_evtype` FOREIGN KEY (`ID_EVENT_TYPE`) REFERENCES `event_type` (`ID_EVENT_TYPE`),
  CONSTRAINT `fk_event_per` FOREIGN KEY (`ID_PERIOD`) REFERENCES `year_period` (`ID_PERIOD`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `history` (
  ...
  KEY `fk_hist_user` (`ID_USERS`),
  KEY `fk_his_event` (`ID_EVENTS`),
  CONSTRAINT `fk_his_event` FOREIGN KEY (`ID_EVENTS`) REFERENCES `events` (`ID_EVENTS`) ON DELETE CASCADE,
  CONSTRAINT `fk_hist_user` FOREIGN KEY (`ID_USERS`) REFERENCES `users` (`ID_USERS`)
...
CREATE TABLE `history_detail` (
  `ID_HISTORY_DETAIL` int(11) NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`ID_HISTORY_DETAIL`),
  KEY `fk_dethis_his` (`ID_HISTORY`),
  KEY `fk_dethis_evdet` (`ID_EVENT_DETAIL`)
...
--
-- Table structure for table `kuliah_log_table_ref`
--

DROP TABLE IF EXISTS `kuliah_log_table_ref`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
--
-- Dumping data for table `kuliah_log_table_ref`
--

LOCK TABLES `kuliah_log_table_ref` WRITE;
/*!40000 ALTER TABLE `kuliah_log_table_ref` DISABLE KEYS */;
INSERT INTO `kuliah_log_table_ref` VALUES
...
('quiz_attempts','quiz');
/*!40000 ALTER TABLE `kuliah_log_table_ref` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `last_refresh_elearning_point`
--

DROP TABLE IF EXISTS `last_refresh_elearning_point`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `last_refresh_elearning_point` (
  ...
  PRIMARY KEY (`NUMBER`),
  KEY `fk_lstref_users` (`ID_USERS`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `last_refresh_elearning_point`
--

LOCK TABLES `last_refresh_elearning_point` WRITE;
/*!40000 ALTER TABLE `last_refresh_elearning_point` DISABLE KEYS */;
/*!40000 ALTER TABLE `last_refresh_elearning_point` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `maintenance_status` VALUES
('active','2022-01-11 02:26:31');
/*!40000 ALTER TABLE `maintenance_status` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `mdl_event_list`
--

DROP TABLE IF EXISTS `mdl_event_list`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `mdl_event_list` (
  `ID_MDL_EVENT_LIST` int(11) NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`ID_MDL_EVENT_LIST`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `mdl_event_list`
--

LOCK TABLES `mdl_event_list` WRITE;
/*!40000 ALTER TABLE `mdl_event_list` DISABLE KEYS */;
/*!40000 ALTER TABLE `mdl_event_list` ENABLE KEYS */;
UNLOCK TABLES;
...
(9,'2023_01_16_210714_add_role_admins_table',3),
(10,'2023_01_16_210657_create_roles_table',4);
/*!40000 ALTER TABLE `migrations` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `missmatch_elearning_history`
--

DROP TABLE IF EXISTS `missmatch_elearning_history`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `missmatch_elearning_history` (
  `ID_MISSMATCH_ELEARNING_HISTORY` int(11) NOT NULL AUTO_INCREMENT,
  `ID_ELEARNING_HISTORY` int(11) NOT NULL,
  `KUL_LOG_OBJECT_ID` varchar(50) NOT NULL,
  PRIMARY KEY (`ID_MISSMATCH_ELEARNING_HISTORY`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `missmatch_elearning_history`
--

LOCK TABLES `missmatch_elearning_history` WRITE;
/*!40000 ALTER TABLE `missmatch_elearning_history` DISABLE KEYS */;
/*!40000 ALTER TABLE `missmatch_elearning_history` ENABLE KEYS */;
UNLOCK TABLES;
...
('22221e48790f156961d9ba1e6e641e6c40338b91397e10957b70b89f85e72cc7f6749810ead4cd74',4,3,'Authentication Token','[]',0,'2023-01-17 18:36:28','2023-01-17 18:36:28','2024-01-17 18:36:28'),
...
('671294511098dcae3b5f4e16f7179cff69a43eea4f5bd25699db7681eb969d66687f802e1c8389ba',1,3,'Authentication Token','[]',0,'2023-01-17 18:37:18','2023-01-17 18:37:18','2024-01-17 18:37:18'),
...
('a57edc2ddbe671cba897047c1a392c41a0f1e46d784e12899d9d665e2c12a4cbc272b63bfc0940a4',3,3,'Authentication Token','[]',0,'2023-01-17 18:35:04','2023-01-17 18:35:04','2024-01-17 18:35:04'),
...
('f13cdaecc4c959d85cca84cb548ce04e6634604677844d99adef27b9c8cdf9b4aab46544ac1a586d',1,3,'Authentication Token','[]',0,'2023-01-17 18:37:05','2023-01-17 18:37:05','2024-01-17 18:37:05'),
...
CREATE TABLE `redeem_log` (
  `ID_REDEEM_LOG` int(11) NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`ID_REDEEM_LOG`),
  KEY `fk_redlog_users` (`ID_USERS`),
  KEY `fk_redlog_redstat` (`ID_REDEEM_STATUS`),
  KEY `fk_redlog_cat` (`ID_CATALOGUE`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
LOCK TABLES `redeem_log` WRITE;
/*!40000 ALTER TABLE `redeem_log` DISABLE KEYS */;
/*!40000 ALTER TABLE `redeem_log` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `redeem_status`
--

DROP TABLE IF EXISTS `redeem_status`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `redeem_status` (
  `ID_REDEEM_STATUS` int(11) NOT NULL AUTO_INCREMENT,
  `REDEEM_STATUS` varchar(100) NOT NULL,
  PRIMARY KEY (`ID_REDEEM_STATUS`),
  UNIQUE KEY `ID_REDEEM_STATUS` (`ID_REDEEM_STATUS`),
  KEY `ID_REDEEM_STATUS_2` (`ID_REDEEM_STATUS`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `redeem_status`
--

LOCK TABLES `redeem_status` WRITE;
/*!40000 ALTER TABLE `redeem_status` DISABLE KEYS */;
INSERT INTO `redeem_status` VALUES
(1,'pending'),
(2,'finish'),
(3,'on process');
/*!40000 ALTER TABLE `redeem_status` ENABLE KEYS */;
UNLOCK TABLES;
...
(1,1,'Dashboard','2023-01-17 18:12:13','2023-01-17 18:12:13'),
(2,1,'Users','2023-01-17 18:12:13','2023-01-17 18:12:13'),
(3,1,'User Challenge History','2023-01-17 18:12:13','2023-01-17 18:12:13'),
(4,1,'User E-Learning Challenge History','2023-01-17 18:12:13','2023-01-17 18:12:13'),
(5,1,'Catalog Manager','2023-01-17 18:12:13','2023-01-17 18:12:13'),
(6,1,'News Manager','2023-01-17 18:12:13','2023-01-17 18:12:13'),
(7,1,'Challenge Manager','2023-01-17 18:12:13','2023-01-17 18:12:13'),
(8,1,'E-Learning Challenge Manager','2023-01-17 18:12:13','2023-01-17 18:12:13'),
(9,1,'Periode Manager','2023-01-17 18:12:13','2023-01-17 18:12:13'),
(10,1,'Device Manager','2023-01-17 18:12:13','2023-01-17 18:12:13'),
(11,1,'Redeem Manager','2023-01-17 18:12:13','2023-01-17 18:12:13'),
(12,1,'Maintenance Manager','2023-01-17 18:12:13','2023-01-17 18:12:13'),
(13,1,'User Review','2023-01-17 18:12:13','2023-01-17 18:12:13'),
(14,1,'Package Manager','2023-01-17 18:12:13','2023-01-17 18:12:13'),
(15,1,'Message Manager','2023-01-17 18:12:13','2023-01-17 18:12:13'),
(16,2,'Dashboard','2023-01-17 18:12:20','2023-01-17 18:12:20'),
(17,2,'Users','2023-01-17 18:12:20','2023-01-17 18:12:20');
...
(1,'All','2023-01-17 18:12:13','2023-01-17 18:12:13'),
(2,'Spare','2023-01-17 18:12:20','2023-01-17 18:12:20');
...
--
-- Table structure for table `year_period`
--
...
--
-- Dumping data for table `year_period`
--

LOCK TABLES `year_period` WRITE;
/*!40000 ALTER TABLE `year_period` DISABLE KEYS */;
INSERT INTO `year_period` VALUES
...
/*!40000 ALTER TABLE `year_period` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2023-01-17 13:32:45
